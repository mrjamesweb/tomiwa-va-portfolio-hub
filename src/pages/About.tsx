    ...
    <div className="min-h-screen py-16">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-16">
          <div className="mb-8">
            <div className="bg-gradient-to-r from-pink-500 to-purple-600 rounded-full p-1 w-48 h-48 mx-auto">
              <img
        ...
        <div className="grid lg:grid-cols-2 gap-12 mb-16">
          ...
          <div className="space-y-6">
            <h2 className="text-3xl font-bold text-slate-900">My Approach</h2>
            <div className="space-y-4">
              {[
                ...
                <div key={index} className="flex items-start gap-3">
                  ...
                  <div>
                    <h3 className="font-semibold text-slate-900">{approach.title}</h3>
          ...
          <div className="grid md:grid-cols-2 gap-8">
            <Card className="hover:shadow-lg transition-shadow">
              <CardContent className="p-8 text-center">
                <GraduationCap className="h-16 w-16 text-pink-500 mx-auto mb-6" />
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <Card>
              <CardContent className="p-6">
                ...
                <h3 className="text-xl font-bold text-slate-900 mb-3">Administrative Excellence</h3>
            ...
            <Card>
              <CardContent className="p-6">
                ...
                <h3 className="text-xl font-bold text-slate-900 mb-3">Client Relations</h3>
                <ul className="space-y-2 text-gray-600">
